...
exports.updateResult = exports.updateLocation = exports.updateChartSettings = exports.logout = exports.login = exports.getLocation = exports.deleteLocation = exports.addLocation = void 0;
...
var getLocation = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(locationId) {
    var shouldAlert,
      res,
      _res$data,
      _args3 = arguments;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          shouldAlert = _args3.length > 1 && _args3[1] !== undefined ? _args3[1] : false;
          _context3.prev = 1;
          _context3.next = 4;
          return (0, _axios.default)({
            method: 'GET',
            url: "/api/location/".concat(locationId)
          });
        case 4:
          res = _context3.sent;
          if (!(res.data.status === 'success')) {
          ...
          return _context3.abrupt("return", res === null || res === void 0 || (_res$data = res.data) === null || _res$data === void 0 ? void 0 : _res$data.data);
        case 8:
          _context3.next = 15;
          break;
        case 10:
  ...
  return function getLocation(_x3) {
    return _ref3.apply(this, arguments);
  };
}();
exports.getLocation = getLocation;
var addLocation = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(locationName, timeLabel) {
    var res;
  ...
  return function addLocation(_x4, _x5) {
    return _ref4.apply(this, arguments);
  };
}();
exports.addLocation = addLocation;
var updateLocation = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(locationId) {
    var locationData,
      res,
      _args5 = arguments;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          locationData = _args5.length > 1 && _args5[1] !== undefined ? _args5[1] : {};
          _context5.prev = 1;
          _context5.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: "/api/location/update/".concat(locationId),
            data: locationData
          });
        case 4:
          res = _context5.sent;
  ...
  return function updateLocation(_x6) {
    return _ref5.apply(this, arguments);
  };
}();
exports.updateLocation = updateLocation;
var deleteLocation = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(locationId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "/api/location/delete/".concat(locationId)
          });
        case 3:
          res = _context6.sent;
          if (res.data.status === 'success') {
  ...
  return function deleteLocation(_x7) {
    return _ref6.apply(this, arguments);
  };
}();
exports.deleteLocation = deleteLocation;
var updateResult = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(locationId, resultDate, result) {
    var res;
  ...
  return function updateResult(_x8, _x9, _x10) {
    return _ref7.apply(this, arguments);
  };
}();
exports.updateResult = updateResult;
var updateChartSettings = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          isChartEnabled = _args8.length > 0 && _args8[0] !== undefined ? _args8[0] : false;
          header = _args8.length > 1 && _args8[1] !== undefined ? _args8[1] : '';
          footer = _args8.length > 2 && _args8[2] !== undefined ? _args8[2] : '';
          whatsappNo = _args8.length > 3 && _args8[3] !== undefined ? _args8[3] : '';
          _context8.prev = 4;
          _context8.next = 7;
          return (0, _axios.default)({
            method: 'PATCH',
  ...
  return function updateChartSettings() {
    return _ref8.apply(this, arguments);
  };
}();
exports.updateChartSettings = updateChartSettings;
...
var updateLocationFormLocationSelectEl = document.querySelector('#updateLocationForm-selectLocation');
var updateLocationForm = document.querySelector('#updateLocationForm');
var deleteLocationForm = document.querySelector('#deleteLocationForm');
var updateResultForm = document.querySelector('#updateResultForm');
var updateChartSettingsForm = document.querySelector('#updateChartSettingsForm');
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    (0, _apis.login)(email, password);
  });
}
if (logoutBtn) logoutBtn.addEventListener('click', _apis.logout);

// Location
if (addLocationForm) {
  addLocationForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var locationName, timeLabel;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            locationName = document.querySelector('#addLocationForm-locationName').value;
            timeLabel = document.querySelector('#addLocationForm-timeLabel').value;
            _context.next = 5;
            return (0, _apis.addLocation)(locationName, timeLabel);
          case 5:
          case "end":
            return _context.stop();
        }
...
if (updateLocationFormLocationSelectEl) {
  updateLocationFormLocationSelectEl.addEventListener('change', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var locationId, location, locationNameEl, timeLabelEl;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            locationId = updateLocationFormLocationSelectEl.value;
            _context2.next = 3;
            return (0, _apis.getLocation)(locationId);
          case 3:
            location = _context2.sent;
            locationNameEl = document.querySelector('#updateLocationForm-locationName');
            timeLabelEl = document.querySelector('#updateLocationForm-timeLabel');
            if (location) {
              locationNameEl.value = location === null || location === void 0 ? void 0 : location.name;
              timeLabelEl.value = location === null || location === void 0 ? void 0 : location.timeLabel;
            }
          case 7:
          case "end":
            return _context2.stop();
...
if (updateLocationForm) {
  updateLocationForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var locationId, locationName, timeLabel, dataToUpdate;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            locationId = updateLocationFormLocationSelectEl.value;
            locationName = document.querySelector('#updateLocationForm-locationName').value;
            timeLabel = document.querySelector('#updateLocationForm-timeLabel').value;
            dataToUpdate = {
              name: locationName,
              timeLabel: timeLabel
            };
            _context3.next = 7;
            return (0, _apis.updateLocation)(locationId, dataToUpdate);
          case 7:
          case "end":
            return _context3.stop();
        }
...
if (deleteLocationForm) {
  deleteLocationForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            e.preventDefault();
            locationId = document.querySelector('#deleteLocationForm-selectLocation').value;
            _context4.next = 4;
            return (0, _apis.deleteLocation)(locationId);
          case 4:
          case "end":
            return _context4.stop();
        }
...
if (updateResultForm) {
  updateResultForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
      var selectLocationEl, locationId, resultDateEl, resultDate, resultEl, result;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            e.preventDefault();
            selectLocationEl = document.querySelector('#updateResultForm-selectLocation');
            locationId = selectLocationEl === null || selectLocationEl === void 0 ? void 0 : selectLocationEl.value;
            resultDateEl = document.querySelector('#updateResultForm-resultDate');
            resultDate = resultDateEl === null || resultDateEl === void 0 ? void 0 : resultDateEl.value;
            resultEl = document.querySelector('#updateResultForm-result');
            result = resultEl === null || resultEl === void 0 ? void 0 : resultEl.value;
            _context5.next = 9;
            return (0, _apis.updateResult)(locationId, resultDate, result);
          case 9:
          case "end":
            return _context5.stop();
        }
...
if (updateChartSettingsForm) {
  updateChartSettingsForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(e) {
      var isChartEnabledEl, isChartEnabled, headerTextEl, headerText, footerTextEl, footerText, whatsappNoTextEl, whatsappNoText;
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            e.preventDefault();
            isChartEnabledEl = document.querySelector('#updateChartSettingsForm-isChartEnabled');
            isChartEnabled = isChartEnabledEl === null || isChartEnabledEl === void 0 ? void 0 : isChartEnabledEl.value;
            headerTextEl = document.querySelector('#updateChartSettingsForm-header');
            headerText = headerTextEl === null || headerTextEl === void 0 ? void 0 : headerTextEl.value;
            footerTextEl = document.querySelector('#updateChartSettingsForm-footer');
            footerText = footerTextEl === null || footerTextEl === void 0 ? void 0 : footerTextEl.value;
            whatsappNoTextEl = document.querySelector('#updateChartSettingsForm-whatsappNo');
            whatsappNoText = whatsappNoTextEl === null || whatsappNoTextEl === void 0 ? void 0 : whatsappNoTextEl.value;
            console.log({
              isChartEnabled: isChartEnabled,
              headerText: headerText,
              footerText: footerText,
              whatsappNoText: whatsappNoText
            });
            _context6.next = 12;
            return (0, _apis.updateChartSettings)(isChartEnabled, headerText, footerText, whatsappNoText);
          case 12:
          case "end":
            return _context6.stop();
        }
